...
namespace CreditCompany.UserControls
{
    public partial class ClientScreen : UserControl
    {
        ...
        private void NewCardRequestBtn_Click_1(object sender, EventArgs e)
        {
            NewCardRequestBtn_Click(sender, e);
        }

        private void BlockCardBtn_Click_1(object sender, EventArgs e)
        {
            BlockCardBtn_Click(sender, e);
        }

        private void TransactionsBtn_Click_1(object sender, EventArgs e)
        {
            TransactionsBtn_Click(sender, e);
        }

        private void RequestsToCompanyBtn_Click_1(object sender, EventArgs e)
        {
            RequestsToCompanyBtn_Click(sender, e);
        }
    }
}
