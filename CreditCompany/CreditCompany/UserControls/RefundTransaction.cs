...
namespace CreditCompany.UserControls
{
    public partial class RefundTransaction : UserControl
    {
        ...
        private void TransactToRefundCB_SelectedIndexChanged(object sender, EventArgs e)
        {

        }
    }
    public class TransactionDisplay:Displayer<TransactionClientProxy>
    {
        public TransactionClientProxy transaction;

        public TransactionDisplay(TransactionClientProxy transaction):base (transaction,null)
        {
